...
var fTransactionsQuery = require('../Query/TransactionQuery');
const addDetails = function (gAccessToken, gRefreshAccessToken, con, req, res) {
    fTransactionsQuery.getStoreIds(con,  function (qbdata) {
        // res.send("success");
    // });
    // con.query("SELECT storeId FROM QBids", function (err, qbdata, fields) {
        ...
        fTransactionsQuery.readTransation(con,  function (rows) {
            // res.send("success");
        // });
